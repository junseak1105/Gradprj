...
public class SortCodeService {
    ...
    public String deleteSortLv1(String sortlv1) throws SQLException {
        log.info("deleteSortLv1");
        String query = "delete from sort_lv1 where sort_lv1 = '" + sortlv1+"'";
        DBService.DB_Ex_query_nr(query);
        return "success";
    }
    public String deleteSortLv2(String sortlv1, String sortlv2) throws SQLException {
    ...
    public String deleteSortCode(String sortlv1, String sortlv2, String sortcode) throws SQLException {
