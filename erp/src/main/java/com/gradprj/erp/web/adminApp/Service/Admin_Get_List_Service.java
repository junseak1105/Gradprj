...
public class Admin_Get_List_Service extends BaseApp implements Admin_Service {
    ...
    public String Execute(String condition) throws SQLException {
        ResultSet rs = db_service.DB_Ex_query("select page_list.idx,page_name,page_desc, page_table,pc.page_category from page_list left join page_category pc on pc.page_category = page_list.page_category;");
        while (rs.next()) {
            Page page = new Page(
